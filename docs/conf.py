# -*- coding: utf-8 -*-
#
# Pika documentation build configuration file, created by
...
project = u'Pika'
copyright = u'2011, Tony Garnock-Jones, Gavin M. Roy and others'
...
latex_documents = [
  ('index', 'Pika.tex', u'Pika Documentation',
   u'Tony Garnock-Jones, Gavin M. Roy and others', 'manual'),
]
...
def process_docstring(app, what, name, obj, options, lines):
    ...
    for x in xrange(0, len(lines)):
        ...
        for match in matches:
            if match[0] in already_checked:
                importable = already_checked[match[0]]
            else:
