...
class Queue(pika.specbase.Class):
    ...
    class Bind(pika.specbase.Method):
        ...
        def __init__(self, ticket=1, queue='', exchange=None, routing_key='', nowait=False, arguments={}):
            self.ticket = ticket
            self.queue = queue
            self.exchange = exchange
    ...
    class Purge(pika.specbase.Method):
        ...
        def __init__(self, ticket=1, queue='', nowait=False):
            self.ticket = ticket
            self.queue = queue
            self.nowait = nowait
    ...
    class Delete(pika.specbase.Method):
        ...
        def __init__(self, ticket=1, queue='', if_unused=False, if_empty=False, nowait=False):
            self.ticket = ticket
            self.queue = queue
            self.if_unused = if_unused
    ...
    class Unbind(pika.specbase.Method):
        ...
        def __init__(self, ticket=1, queue='', exchange=None, routing_key='', arguments={}):
            self.ticket = ticket
            self.queue = queue
            self.exchange = exchange
            self.routing_key = routing_key
...
class Basic(pika.specbase.Class):
    ...
    class Consume(pika.specbase.Method):
        ...
        def __init__(self, ticket=1, queue='', consumer_tag='', no_local=False, no_ack=False, exclusive=False, nowait=False):
            self.ticket = ticket
            self.queue = queue
    ...
    class Get(pika.specbase.Method):
        ...
        def __init__(self, ticket=1, queue='', no_ack=False):
            self.ticket = ticket
            self.queue = queue
            self.no_ack = no_ack
...
class Stream(pika.specbase.Class):
    ...
    class Consume(pika.specbase.Method):
        ...
        def __init__(self, ticket=1, queue='', consumer_tag='', no_local=False, exclusive=False, nowait=False):
            self.ticket = ticket
            self.queue = queue
            self.consumer_tag = consumer_tag
            self.no_local = no_local
...
def has_content(methodNumber):
    ...
    if methodNumber == Basic.GetOk.INDEX:
        return True
    if methodNumber == File.Stage.INDEX:
        return True
    if methodNumber == File.Return.INDEX:
        return True
    if methodNumber == Stream.Publish.INDEX:
        return True
    if methodNumber == Stream.Return.INDEX:
        return True
    if methodNumber == Stream.Deliver.INDEX:
        return True
    if methodNumber == Tunnel.Request.INDEX:
        return True
    if methodNumber == Test.Content.INDEX:
        return True
    if methodNumber == Test.ContentOk.INDEX:
        return True
    return False
...
class DriverMixin(object):
    ...
    def queue_bind(self, ticket=1, queue='', exchange=None, routing_key='', nowait=False, arguments={}):
    ...
    def queue_purge(self, ticket=1, queue='', nowait=False):

        return self.handler.rpc(self._on_synchronous_complete, Queue.Purge(ticket=ticket, queue=queue, nowait=nowait),
                                [Queue.PurgeOk])

    def queue_delete(self, ticket=1, queue='', if_unused=False, if_empty=False, nowait=False):
    ...
    def queue_unbind(self, ticket=1, queue='', exchange=None, routing_key='', arguments={}):
    ...
    def basic_get(self, ticket=1, queue='', no_ack=False):
